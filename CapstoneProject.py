   ...
   #converting coordinates
    ...
    with action_col:
        ...
        st.markdown(
            ...
            unsafe_allow_html=True)
        st.markdown(f"<h5 style='text-align: left; color: white;'> 2. Find them on the map  </h5>",
                    unsafe_allow_html=True)
            ...
            if len(uploaded_image) != 0:
                ...
                if lat:
                    ...
                    if len(uploaded_image) != len(df):
                          st.markdown(
                        f"<h5 style='text-align: left; color: white;'> ⚠️ One of the images didn't have GPS info  </h5>",
                        unsafe_allow_html=True)
